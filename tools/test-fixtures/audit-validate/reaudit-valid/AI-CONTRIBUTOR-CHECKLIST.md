...
| Scope    | Rule        | A   | Status     | Comment                                              | Requirement                                                                                    | Pillar | IDs                      |
| -------- | ----------- | --- | ---------- | ---------------------------------------------------- | ---------------------------------------------------------------------------------------------- | ------ | ------------------------ |
| `SHOULD` | `Mock Mode` | -   | ⚠️ Warning | Changed from ✅ Fulfilled to ⚠️ Warning because `README.md:42` no longer documents a mock mode; deferred | The project offers a safe local mode that avoids requiring live credentials during onboarding. | 2      | `AIC-mock-mode-fallback` |

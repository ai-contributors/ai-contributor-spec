...
| Scope    | Rule        | A   | Status     | Comment                             | Requirement                                                                                    | Pillar | IDs                      |
| -------- | ----------- | --- | ---------- | ----------------------------------- | ---------------------------------------------------------------------------------------------- | ------ | ------------------------ |
| `SHOULD` | `Mock Mode` | -   | ⚠️ Warning | No mock-mode instructions; deferred | The project offers a safe local mode that avoids requiring live credentials during onboarding. | 2      | `AIC-mock-mode-fallback` |

...
| `MUST when applicable` | `SBOM`              | -   | ➖ Not relevant | seems fine                                                                                                                                                    | **Triggered when:** the repository ships artifacts. **Requirement:** a software bill of materials can be generated and release dependencies can be identified. | 4      | `AIC-release-dependency-identification`, `AIC-sbom-generation` |

...
| Scope                  | Rule                | A   | Status          | Comment                                                                                         | Requirement                                                                                                                                                    | Pillar | IDs                                                            |
| ---------------------- | ------------------- | --- | --------------- | ----------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ | -------------------------------------------------------------- |
| `MUST`                 | `Branch Protection` | -   | ✅ Fulfilled    | `gh api repos/:owner/:repo/branches/main/protection` → `required_pull_request_reviews: enabled` | Protected branches and required checks are enabled.                                                                                                            | 4      | `AIC-default-branch-protected`                                 |

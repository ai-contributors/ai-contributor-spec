...
| `Branch Protection` | 4 | L1 | Protected branches and required checks are enabled. | ✅ Fulfilled | `gh api repos/:owner/:repo/branches/main/protection` → `required_pull_request_reviews: enabled` |
...
| Rule | Pillar | Min Level | Requirement | Status | Comment |
|------|--------|-----------|-------------|--------|---------|
| `Mock Mode` | 2 | L4 | Safe local mode that avoids requiring live credentials. | ⚠️ Warning | No mock fixture documented; deferred |

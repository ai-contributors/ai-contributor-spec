...
| Rule | Pillar | Min Level | Requirement | Status | Comment |
|------|--------|-----------|-------------|--------|---------|
| `SBOM` | 4 | L1 | Repositories that ship artifacts can generate a software bill of materials. | ➖ Not relevant | No public release — repo is internal-only, the team has confirmed it does not apply |

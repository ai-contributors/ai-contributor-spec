...
| ------ | ---------------- | --- | ------------ | ---------------------------------------- | ---------------------------------------------------------------------- | ------ | ------------------------ |
| `MUST` | `Secret Hygiene` | -   | ✅ Fulfilled | `rg --files -g '.env'` → env file listed | Secrets and local environment files are excluded from version control. | 2      | `AIC-secret-vcs-exclude` |
